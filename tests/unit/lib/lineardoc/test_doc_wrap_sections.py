...
from python.lib.mw.mw_page_loader import Parser, load_removable_sections
...
expectedSectionWrappedHTML = """<body>
...
sectionWithCategoriesExpectedHtml = """
    <body class="mw-content-ltr sitedir-ltr ltr mw-body-content parsoid-body mediawiki mw-parser-output" dir="ltr" id="mwAA" lang="en">
    <section rel="cx:Section">
...
nestedSectionsWithTransclusion = """
    <body>
...
nestedSectionsWithTransclusionExpected = """
    <body>
    <section rel="cx:Section">
    <p id="mw5Q">
...
sectionWithBlankTemplateExpected = """
<body>
<section rel="cx:Section">
...
<p id="mwBQ"><b id="mwBg">test</b></p>
</section>
</body>
"""

sectionWithMetaResult = """
<body id="mwAA" lang="he">
<section rel="cx:Section">
<meta content="test" id="mwAg" property="mw:PageProp/displaytitle" />
</section>
<section rel="cx:Section">
...
<section rel="cx:Section">
<p id="mwBQ"><b id="mwBg">test</b>
</p>
</section>
</body>
"""

sectionWithFigureInlineTemplate = """
<html>
    <body>
...
sectionWithFigureInlineTemplateResult = """
<html>
<body>
    <section rel="cx:Section">
    <h2 id="Enlaces_externos">Enlaces externos</h2>
...
sectionWithIgnorableTransclusionFragment = """
<body>
    <section data-mw-section-id="0" id="mwAQ">
...
sectionWithIgnorableTransclusionFragmentResult = """
<body>
    <section rel="cx:Section">
        <span about="#mwt4" typeof="mw:Transclusion"
            data-mw="{&quot;parts&quot;:[{&quot;template&quot;:{&quot;target&quot;:{&quot;wt&quot;:&quot;Generations Sidebar&quot;,&quot;href&quot;:&quot;./Template:Generations_Sidebar&quot;},&quot;params&quot;:{},&quot;i&quot;:0}}]}"
...
sectionWithTemplateAndTemplateStyles = """
<body>
    <section data-mw-section-id="0" id="mwAQ">
    <ul>
    <li>
...
sectionWithTemplateAndTemplateStylesResult = """
<body>
    <section rel="cx:Section">
    <ul>
    <li>
